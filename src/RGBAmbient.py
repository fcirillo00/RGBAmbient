...
center_size = float(1 - config["border_size"])/100
HEIGHT_CENTER_LEFT = int( (HEIGHT-HEIGHT*center_size ) / 2 )
HEIGHT_CENTER_RIGHT = int( (HEIGHT+HEIGHT*center_size) /2 )
WIDTH_CENTER_LEFT = int( (WIDTH-WIDTH*center_size ) / 2 )
WIDTH_CENTER_RIGHT = int( (WIDTH+WIDTH*center_size ) / 2 )
